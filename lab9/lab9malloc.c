Сформировать матрицу  В  путем  вычеркивания  строки  и столбца матрицы А, на  пересечении  которых  находится  мaксимальный элемент матрицы А. Определить количество строк, в которых есть нули и записать в обратном порядке главную диагональ матрицы.

исправь ошибки в коде решения задания
